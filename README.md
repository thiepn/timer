...
- `visual-system.css` — semantic materials, typography, shapes, motion, accents, themes and V3 shell architecture
- `icons.svg` — offline SVG icon sprite for product chrome
