...
if (pkg.version !== '2.2.0') fail(`package version is ${pkg.version}, expected 2.2.0`);
...
if (!cacheMatch || Number(cacheMatch[1]) !== 14) fail('service-worker cache generation must be v14');
...
if (!readme.includes('Current app version: **2.2.0**')) fail('README does not identify v2.2.0');
