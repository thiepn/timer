...
if (pkg.version !== '2.3.0') fail(`package version is ${pkg.version}, expected 2.3.0`);
...
if (!cacheMatch || Number(cacheMatch[1]) !== 15) fail('service-worker cache generation must be v15');
...
if (!readme.includes('Current app version: **2.3.0**')) fail('README does not identify v2.3.0');
